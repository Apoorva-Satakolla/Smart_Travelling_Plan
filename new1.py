...
# Load dataset
DATA_PATH = r'C:\Users\91799\OneDrive\Desktop\MY docs\PROJECTS\Smart Travelling Plan\Placestestf.csv'
...
def recommend_places(city, categories, num_days, places_per_day):
    ...
    k = min(len(combined_places), 5)  # Ensure clusters do not exceed available places
...
def map(day):
    ...
    return "Map not available for the selected day.", 404
